...
namespace AirlinesSolutions.Controllers
{
    public class AirportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Location,IATACode")] Airport airport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Location,IATACode")] Airport airport)
        {
            if (id != airport.Id)
            {
                return NotFound();
